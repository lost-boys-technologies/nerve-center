...
function NotFound() {
    document.addEventListener('DOMContentLoaded', function(e) {
        document.getElementsByClassName('nav-link-container')[0].style.display = 'none';
    })
            ...
            <div className="circle circle--inner">
              ...
              <div className="circle oh">
                ...
                <svg className="astronaut-wire" viewBox="-9 -9 259 823" width={259} height={823}>
                  <path d="M241 0c-24 54-30 113-78 148S63 159 27 215c-35 55 32 102 73 141s103 94 98 166c-6 97-169 66-192 157-10 43-8 84 9 126" fill="none" strokeWidth={6} stroke="#FFF" />
                </svg>
              ...
              <a href="/" className="button go-home-button">GO HOME</a>
            </div>
